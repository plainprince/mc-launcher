...
// Create event emitter for Electron GUI logging
const electronEmitter = new EventEmitter();
            ...
            mainWindow.webContents.on("did-finish-load", () => {
                ...
                if (loc.startsWith("https://login.live.com/oauth20_desktop.srf")) {
                    ...
                    try {
                        ...
                        const errorMessage = "Failed to close window!";
                        electronEmitter.emit('log', 'error', errorMessage);
                        // Keep console.error as fallback for critical GUI errors
...
module.exports.electronEmitter = electronEmitter;
